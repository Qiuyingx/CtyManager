...
public class ManagerConstant {
	...
	// 存入用户的培训室ID
	public static final String SESSION_TRAIN_ID = "loginTrainID";
	...
	public static final String SHOW_PUSH_TEXT_VALI_TRAIN_FAILED = "你好！你的开店申请未通过审核，具体原因是：${detailReasons}"; //开店申请审核不通过 ${detailReasons} 具体原因（后台填写）
	public static final String SHOW_PUSH_TEXT_VALI_TRAIN_SUCCESS = "你好！你的开店申请未通过审核，点击查看具体原因。"; // 开店申请通过审核
	...
	public static final String SHOW_RECORD_TEXT_VALI_TRAIN_FAILED = "你好！恭喜你，你的开店申请已经审核通过。"; // 开店申请审核不通过
