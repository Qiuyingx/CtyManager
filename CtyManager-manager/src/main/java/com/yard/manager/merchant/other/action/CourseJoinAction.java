...
import com.yard.manager.merchant.other.entity.CourseJoinViewEntity;
import com.yard.manager.merchant.other.entity.query.CourseJoinQueryEntity;
import com.yard.manager.merchant.other.service.CourseJoinService;
 ...
 */
@Results({
	@Result(type = "freemarker", name = "coursejoinindex", location = "/WEB-INF/content/merchant/other/coursejoinindex.html")
})
public class CourseJoinAction extends BaseAction {
	private static final long serialVersionUID = -3719531580009240976L;
	private static final String NAMESPACE = "/other/course/coursejoin";
