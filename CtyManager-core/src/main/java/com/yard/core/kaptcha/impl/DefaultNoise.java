...
public class DefaultNoise extends Configurable implements NoiseProducer {
	/**
	 * Draws a noise on the image. The noise curve depends on the factor values. Noise won't be visible if all factors have the
	 * value > 1.0f
	 * 
	 * @param image
	...
	public void makeNoise(BufferedImage image, float factorOne, float factorTwo, float factorThree, float factorFour) {
		...
		CubicCurve2D cc = new CubicCurve2D.Float(width * factorOne, height * rand.nextFloat(), width * factorTwo, height
