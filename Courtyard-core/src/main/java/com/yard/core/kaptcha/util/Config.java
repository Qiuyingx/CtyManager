package com.yard.core.kaptcha.util;

import java.awt.Color;
import java.awt.Font;
import java.util.Properties;

import com.yard.core.kaptcha.BackgroundProducer;
import com.yard.core.kaptcha.Constants;
import com.yard.core.kaptcha.GimpyEngine;
import com.yard.core.kaptcha.NoiseProducer;
import com.yard.core.kaptcha.Producer;
import com.yard.core.kaptcha.impl.DefaultBackground;
import com.yard.core.kaptcha.impl.DefaultKaptcha;
import com.yard.core.kaptcha.impl.DefaultNoise;
import com.yard.core.kaptcha.impl.WaterRipple;
import com.yard.core.kaptcha.text.TextProducer;
import com.yard.core.kaptcha.text.WordRenderer;
import com.yard.core.kaptcha.text.impl.DefaultTextCreator;
import com.yard.core.kaptcha.text.impl.DefaultWordRenderer;

/**
 * {@link Config} retrieves configuration values from properties file and specifies default values when no value is specified.
 */
public class Config {
	/** */
	...
	public TextProducer getTextProducerImpl() {
		...
		String paramValue = this.properties.getProperty(paramName);
		TextProducer textProducer = (TextProducer) this.helper.getClassInstance(paramName, paramValue, new DefaultTextCreator(),
				this);
		return textProducer;
	}
	...
	public Font[] getTextProducerFonts(int fontSize) {
		...
		String paramValue = this.properties.getProperty(paramName);
		return this.helper.getFonts(paramName, paramValue, fontSize, new Font[] { new Font("Arial", Font.BOLD, fontSize),
	...
	public NoiseProducer getNoiseImpl() {
		...
		String paramValue = this.properties.getProperty(paramName);
		NoiseProducer noiseProducer = (NoiseProducer) this.helper.getClassInstance(paramName, paramValue, new DefaultNoise(),
				this);
	...
	public WordRenderer getWordRendererImpl() {
		...
		String paramValue = this.properties.getProperty(paramName);
		WordRenderer wordRenderer = (WordRenderer) this.helper.getClassInstance(paramName, paramValue, new DefaultWordRenderer(),
				this);
		return wordRenderer;
	}
